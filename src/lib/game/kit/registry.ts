import {
  ...
  buildHarbourNetRack,
  buildHarbourFreightCart,
  buildHarbourPierBeacon,
  buildHarbourRailShed,
  buildHarbourSailRack,
  ...
  buildMoonhillMeteorMarker,
  buildMoonhillOrrery,
  buildMoonhillBaggageTrolley,
  buildMoonhillStarChartTable,
  buildMoonhillStarTeaKiosk,
  buildMoonhillSkyrailShelter,
...
export const kitRegistry: Record<KitId, KitDefinition> = {
  ...
  'harbour-rail-shed': {
    id: 'harbour-rail-shed',
    gltfUrl: '/assets/gltf/harbour-rail-shed-01.glb',
    build: () => buildHarbourRailShed(),
  },
  'harbour-freight-cart': {
    id: 'harbour-freight-cart',
    gltfUrl: '/assets/gltf/harbour-freight-cart-01.glb',
    build: () => buildHarbourFreightCart(),
  },
  'harbour-pier-beacon': {
    id: 'harbour-pier-beacon',
    gltfUrl: '/assets/gltf/harbour-pier-beacon-01.glb',
    build: () => buildHarbourPierBeacon(),
  },
  'harbour-chandlery': {
    id: 'harbour-chandlery',
    gltfUrl: '/assets/gltf/harbour-chandlery-01.glb',
    build: () => buildHarbourChandlery(),
  },
  'harbour-sail-rack': {
    id: 'harbour-sail-rack',
    gltfUrl: '/assets/gltf/harbour-sail-rack-01.glb',
    build: () => buildHarbourSailRack(),
  },
  'harbour-capstan': {
    id: 'harbour-capstan',
    gltfUrl: '/assets/gltf/harbour-capstan-01.glb',
    build: () => buildHarbourCapstan(),
  },
  ...
  'moonhill-skyrail-shelter': {
    id: 'moonhill-skyrail-shelter',
    gltfUrl: '/assets/gltf/moonhill-skyrail-shelter-01.glb',
    build: () => buildMoonhillSkyrailShelter(),
  },
  'moonhill-baggage-trolley': {
    id: 'moonhill-baggage-trolley',
    gltfUrl: '/assets/gltf/moonhill-baggage-trolley-01.glb',
    build: () => buildMoonhillBaggageTrolley(),
  },
  'moonhill-wind-shelter': {
    id: 'moonhill-wind-shelter',
    gltfUrl: '/assets/gltf/moonhill-wind-shelter-01.glb',
    build: () => buildMoonhillWindShelter(),
  },
  'moonhill-star-chart-table': {
    id: 'moonhill-star-chart-table',
    gltfUrl: '/assets/gltf/moonhill-star-chart-table-01.glb',
    build: () => buildMoonhillStarChartTable(),
  },
  'moonhill-meteor-marker': {
    id: 'moonhill-meteor-marker',
    gltfUrl: '/assets/gltf/moonhill-meteor-marker-01.glb',
    build: () => buildMoonhillMeteorMarker(),
  },
  'moonhill-chartmaker': {
    id: 'moonhill-chartmaker',
    gltfUrl: '/assets/gltf/moonhill-chartmaker-01.glb',
    build: () => buildMoonhillChartmaker(),
  },
  'moonhill-star-tea-kiosk': {
    id: 'moonhill-star-tea-kiosk',
    gltfUrl: '/assets/gltf/moonhill-star-tea-kiosk-01.glb',
    build: () => buildMoonhillStarTeaKiosk(),
  },
  'char-player': {
    id: 'char-player',
